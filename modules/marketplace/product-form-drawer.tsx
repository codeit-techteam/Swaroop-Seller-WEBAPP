    ...
    >
      ...
      >
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field
                ...
                htmlFor="product-transport"
                required
              >
                <Input
                  id="product-transport"
                  placeholder="Road Freight (FTL)"
                  className="h-10 bg-white"
        ...
        <TabsContent value="publish" className="mt-0 space-y-4">
          <Section
            title="Publishing"
            description="Control when this SKU appears on Customer APP and WEB."
          ...
          >
            <Field label="Publish status" hint={PUBLISH_HINTS[publishStatus]}>
              ...
              >
                ...
                <SelectContent>
                  {(Object.keys(PUBLISH_HINTS) as PublishStatus[]).map(
                    (status) => (
            ...
            {publishStatus === "LIVE" ? (
              <div className="flex gap-2.5 rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-xs leading-relaxed text-blue-800">
                <Info className="mt-0.5 h-4 w-4 shrink-0" />
                <p>
                  This SKU will appear on Customer APP and WEB with the pricing,
                  specs and payment terms you set here.
                </p>
              </div>
            ) : (
              <div className="flex gap-2.5 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs leading-relaxed text-slate-600">
